...
async function tutorial() {
	try {
		const URL = 'https://www.public.gr/cat/wearables-gadgets/gadgets-ygeias-and-athlisis?r=90&ob=disc'
		config = await common_code.init(URL)

		await config.page.waitForSelector('div.col.col-6.col-lg-4.col-xl-3.product--view--grid')
		let pagesToScrape = 1;
		let currentPage = 1
		let data = []
