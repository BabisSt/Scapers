...
async function tutorial() {
	try {
		const URL = 'https://www.plaisio.gr/pc-perifereiaka/laptops/clearance?location=categories%3dpc+%26+%ce%a0%ce%b5%cf%81%ce%b9%cf%86%ce%b5%cf%81%ce%b5%ce%b9%ce%b1%ce%ba%ce%ac%2claptops%3bproductstatusdescr%3dclearance%2c%ce%a0%cf%81%ce%bf%cf%83%cf%86%ce%bf%cf%81%ce%ac'
		config = await common_code.init(URL)

		let pagesToScrape = 10;
		let currentPage = 1
		let data = []
