...
async function tutorial() {
	try {
		const URL = 'https://www.skroutz.gr/c/1850/Gaming_Headsets.html?price_drops=1'
		...
		while (currentPage <= pagesToScrape) {
			...
			if (currentPage < pagesToScrape) {
				await config.page.goto('https://www.skroutz.gr/c/1850/Gaming_Headsets.html?price_drops=1&page=' + (currentPage + 1), {
