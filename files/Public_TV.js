...
async function tutorial() {
	try {
		const URL = 'https://www.public.gr/cat/tileoraseis/tileoraseis?r=90&ob=disc'
		...
		var stringified_all = '{"product" :' + stringified + '}'
		fs.writeFile("/tmp/Public_TVs.json", stringified_all, function (err) {
			if (err) throw err;
