...
async function tutorial() {
	try {
		const URL = 'https://www.plaisio.gr/gaming-zone/titloi-paixnidion/sales?location=categories%3dgaming+zone%2c%ce%a4%ce%af%cf%84%ce%bb%ce%bf%ce%b9+%ce%a0%ce%b1%ce%b9%cf%87%ce%bd%ce%b9%ce%b4%ce%b9%cf%8e%ce%bd%3bproductstatusdescr%3dsales%2c%ce%9d%ce%ad%ce%bf%2c%ce%a0%cf%81%ce%bf%cf%83%cf%86%ce%bf%cf%81%ce%ac'
		config = await common_code.init(URL)

		let pagesToScrape = 15;
		let currentPage = 1
		let data = []
