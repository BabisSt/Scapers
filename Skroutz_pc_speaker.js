...
async function tutorial() {
	try {
		const URL = 'https://www.skroutz.gr/c/112/hxeia-ypologisti.html?price_drops=1'
		...
		while (currentPage <= pagesToScrape) {
			...
			if (currentPage < pagesToScrape) {
				await config.page.goto('https://www.skroutz.gr/c/112/hxeia-ypologisti.html?price_drops=1&page=' + (currentPage + 1), {
