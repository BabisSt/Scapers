...
async function tutorial() {
	try {
		const URL = 'https://www.plaisio.gr/tileoraseis/home-audio/clearance?location=categories%3d%ce%a4%ce%b7%ce%bb%ce%b5%ce%bf%cf%81%ce%ac%cf%83%ce%b5%ce%b9%cf%82%2chome+audio%3bproductstatusdescr%3dclearance%2c%ce%a0%cf%81%ce%bf%cf%83%cf%86%ce%bf%cf%81%ce%ac'
		config = await common_code.init(URL)

		let pagesToScrape = 17;
		let currentPage = 1
		let data = []
